...
In two hours at 11th Hour Coffee, I leveraged ChatGPT to accelerate architecture and set up a Vercel Next.js portfolio and blog template from a blank Mac to a live localhost domain pointing at westonmossman.com. I configured DNS, validated local routing, and identified an MDX “two React versions” bug that’s ideal for AI-assisted debugging. Next steps include deploying to Cloudflare, integrating a CMS via REST/Next.js, and defining analytics goals. This sprint showcases my ability to rapidly prototype a maintainable, high-quality web application with minimal setup overhead.
