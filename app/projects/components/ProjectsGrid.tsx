...
export default function ProjectsGrid({ projects }: { projects: any[] }) {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-amber-100 dark:bg-amber-950 border-l-4 border-amber-500 p-4 mb-8 rounded-lg">
      ...
      <div className="flex justify-between items-start mb-6">
        <h3 className="text-lg font-semibold inline-block mt-2">Filter By Tags</h3>
