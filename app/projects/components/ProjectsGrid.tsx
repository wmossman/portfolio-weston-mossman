  ...
  return (
    <>
      ...
      <div className="bg-accent-highlight/20 border-l-4 border-accent-highlight p-4 mb-8 rounded-lg">
        <div className="flex items-start">
          <div className="flex-shrink-0">
            <svg
              className="h-5 w-5 text-accent-highlight"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
          ...
          <div className="ml-3">
            <p className="text-sm text-text-primary">
              <strong>Note:</strong> This page and its contents are under
              construction. Feel free to reach out if you have any questions!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between items-start mb-6">
        <h3 className="text-lg font-semibold inline-block mt-2 text-text-heading">
          Filter By Tags
        </h3>
